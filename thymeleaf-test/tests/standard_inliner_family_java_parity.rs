...
const FIXTURES: &[(&str, &str)] = &[
    (
        "inlining001",
        "a2d0be59bc93902aa3f8db80bd40877d68619ef5feee0c3db92c209f36805551",
    ),
    (
        "inlining002",
        "d42d48b2dc06c4656b2f66efba3f6a9656e50da88d0459f4c900f123cf589372",
    ),
    (
        "inlining005",
        "5f27b14b572cad78301d7966fca2bfdb35c4c0842ccacde04b3a448f19c561b9",
    ),
    (
        "inlining006",
        "e2283fd189cf05fb58d5b0127ae553610f23f80aa4ae43dac4b7804ae8005eeb",
    ),
    (
        "inlining007",
        "383d6e6ae008f7d3b29bb875c83c73f4f58ea46e2b5f1a04ea53e235fadd9165",
    ),
    (
        "inlining008",
        "5228d5577cd35b707562ce9121b34e1093c86d90ebd4673a30b6891aca620a5c",
    ),
    (
        "inlining011",
        "7da06189b724109734eb03a842decb060df3b849ac1743e6cac9d3eea51f762c",
    ),
    (
        "inlining012",
        "ab83470900200e8b386f86e05e1c5e745e764757e576f04c0a761c10639a4f4e",
    ),
    (
        "inlining110",
        "918bd98058bf9a9d8ba310643217fb0915ec72bd788c0c8d70ff036c122f3e24",
    ),
    (
        "inline01",
        "bcd4a3982034a65b0f527b404ad3324e5b226706c2718cd196f83cb790e2ef92",
    ),
    (
        "inline29",
    ...
    (
        "inline31",
        "3239e2a7f51add65e69fee07d0c55d575b26ba6b8cf583bfd1a813fa1f149b78",
    ),
    (
        "inline32",
        "95d1f21a5530564a6275729fbe86e4974f81085b014b84865649a0f6393dd9ae",
    ),
    (
        "inline34",
        "f461d712709325b604ba467c70dcc3d783bde9ec6a8c106021272734b85ac9c7",
    ),
];

fn fixture_bytes(name: &str) -> Vec<u8> {
    std::fs::read(format!(
        "{}/../thymeleaf/tests/fixtures/inlining/{name}.thtest",
    ...
    while index < bytes.len() {
        ...
        if byte == b'\\' && index + 1 < bytes.len() {
            match bytes[index + 1] {
                ...
                b'u' => {
                    let hex =
                        std::str::from_utf8(&bytes[index + 2..index + 6]).expect("hex escape");
...
fn inline34_exception_message_matches_java_pattern() {
    ...
    assert!(
        messages
            .iter()
            .any(|message| message.contains("Invalid inline mode selected")),

...
use super::{CorpusOgnlRuntime, TestStandardConversionService4};

/// 使用 conversion4 自定义转换服务的 Standard Dialect。
///
/// 对应 Java:
/// `org.thymeleaf.templateengine.conversion.conversion4.ConversionTestDialect4`。
pub struct ConversionTestDialect4 {
    standard_dialect: StandardDialect,
}

impl ConversionTestDialect4 {
    ...
    pub fn new() -> Self {
        ...
        standard_dialect.set_conversion_service(Arc::new(TestStandardConversionService4));
        Self { standard_dialect }
    }
}

impl Default for ConversionTestDialect4 {
    fn default() -> Self {
        Self::new()
    }
}

impl IDialect for ConversionTestDialect4 {
...
impl IProcessorDialect for ConversionTestDialect4 {
...
impl IExecutionAttributeDialect for ConversionTestDialect4 {

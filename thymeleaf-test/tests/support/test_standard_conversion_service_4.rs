...
///
/// 对应 Java:
/// `org.thymeleaf.templateengine.conversion.conversion4.TestStandardConversionService4`。
pub struct TestStandardConversionService4;

impl AbstractStandardConversionService for TestStandardConversionService4 {
    /// 调用 Java 默认 `toString()` 语义，并在结果外增加方括号。
    ///
    /// 对应 Java: `TestStandardConversionService4#convertToString`。

...
| Public Rust API | Verified slices | Foundation/configuration APIs, cache families, `StandardCache`, `TemplateResolution`, template-resource SPI/string/file resources, `NumberPointType`, `IdentityCounter`, `Validate`, `MapUtils`, and `ObjectUtils`; URL and JVM soft-reference runtime edges remain pending |
...
| Tests and CI | Slice gates passing | 109 unit tests, thirteen Java/Rust Golden tests with 864 records, 100% line/function/region coverage |

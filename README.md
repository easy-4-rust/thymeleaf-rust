...
| Public Rust API | Verified slices | Foundation/configuration APIs, cache families, `TemplateResolution`, and the template-resource SPI/string/file resources; URL file/HTTP/HTTPS support is implemented pending full protocol verification |
...
| Tests and CI | Slice gates passing | 79 unit tests, nine Java/Rust Golden tests with 719 records, 100% line/function/region coverage |

...
| Public Rust API | Verified slices | Foundation/configuration APIs plus cache-entry validity and cache-key families |
...
| Tests and CI | Slice gates passing | 48 unit tests, six Java/Rust Golden tests with 495 records, 100% line/function/region coverage |

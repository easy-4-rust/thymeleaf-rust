...
| Public Rust API | Verified slices | Foundation/configuration APIs plus cache contracts, entry validity, and cache-key families |
...
| Tests and CI | Slice gates passing | 51 unit tests, seven Java/Rust Golden tests with 509 records, 100% line/function/region coverage |

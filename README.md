...
| Public Rust API | Verified slices | Foundation/configuration APIs, cache families, `StandardCache`, `TemplateResolution`, template-resource SPI/string/file resources, `NumberPointType`, and `IdentityCounter`; URL and JVM soft-reference runtime edges remain pending |
...
| Tests and CI | Slice gates passing | 96 unit tests, eleven Java/Rust Golden tests with 788 records, 100% line/function/region coverage |

...
| Public Rust API | Verified slices | Foundation/configuration APIs, cache families, and the template-resource SPI/string/file resources; URL file/HTTP/HTTPS support is implemented pending full protocol verification |
...
| Tests and CI | Slice gates passing | 76 unit tests, eight Java/Rust Golden tests with 653 records, 100% line/function/region coverage |

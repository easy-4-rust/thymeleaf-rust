...
| Public Rust API | Verified slices | Foundation/configuration APIs plus the complete cache-entry-validity family |
...
| Tests and CI | Slice gates passing | 39 unit tests, five Java/Rust Golden tests with 437 records, 100% line/function/region coverage |

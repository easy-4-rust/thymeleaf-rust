...
| Public Rust API | Verified slices | Foundation/configuration APIs, cache families, `StandardCache`, `TemplateResolution`, template-resource SPI/string/file resources, `NumberPointType`, `IdentityCounter`, and `Validate`; URL and JVM soft-reference runtime edges remain pending |
...
| Tests and CI | Slice gates passing | 103 unit tests, twelve Java/Rust Golden tests with 824 records, 100% line/function/region coverage |

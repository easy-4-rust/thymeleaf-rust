...
/// JAVASCRIPT 模式高层模板 Parser。
///
/// 对应 Java: `org.thymeleaf.templateparser.text.JavaScriptTemplateParser`。
pub struct JavaScriptTemplateParser {
...
impl ITemplateParser for JavaScriptTemplateParser {
    fn parse_standalone(
        &self,

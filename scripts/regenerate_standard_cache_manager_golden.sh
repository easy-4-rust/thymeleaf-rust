...
output="${2:-${project_root}/thymeleaf/tests/fixtures/standard_cache_manager_golden.txt}"
...
javac -encoding UTF-8 -cp "${classes}:${slf4j_api}" -d "${temporary_dir}" \
    "${project_root}/thymeleaf-test/tests/java/StandardCacheManagerGolden.java"

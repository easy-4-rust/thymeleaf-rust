...
output="${2:-${project_root}/thymeleaf/tests/fixtures/text_parser_foundation_golden.txt}"
...
javac -encoding UTF-8 -d "${temporary_dir}" \
    ...
    "${project_root}/thymeleaf-test/tests/java/TextParserFoundationGolden.java"

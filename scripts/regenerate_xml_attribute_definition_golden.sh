...
output="${2:-${project_root}/tests/fixtures/xml_attribute_definition_golden.txt}"
...
javac -encoding UTF-8 -cp "${java_classpath}" -d "${temporary_dir}" \
  "${project_root}/tests/java/org/thymeleaf/engine/XMLAttributeDefinitionGolden.java"

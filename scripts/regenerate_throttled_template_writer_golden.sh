...
output="${2:-${project_root}/thymeleaf/tests/fixtures/throttled_template_writer_golden.txt}"
...
javac -encoding UTF-8 -cp "${java_classpath}" -d "${temporary_dir}" \
  "${project_root}/thymeleaf-test/tests/java/org/thymeleaf/engine/ThrottledTemplateWriterGolden.java"

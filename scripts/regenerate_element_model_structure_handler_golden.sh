...
output="${2:-${project_root}/tests/fixtures/element_model_structure_handler_golden.txt}"
...
javac -encoding UTF-8 -cp "${java_classpath}" -d "${temporary_dir}" "${project_root}/tests/java/org/thymeleaf/engine/ElementModelStructureHandlerGolden.java"

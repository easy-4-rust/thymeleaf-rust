...
output="${2:-${project_root}/tests/fixtures/non_element_structure_handler_golden.txt}"
...
javac -encoding UTF-8 -cp "${classpath}" -d "${temporary_dir}" \
    "${project_root}/tests/java/org/thymeleaf/engine/NonElementStructureHandlerGolden.java"

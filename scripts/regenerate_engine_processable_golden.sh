...
output="${2:-${project_root}/thymeleaf/tests/fixtures/engine_processable_golden.txt}"
...
javac -encoding UTF-8 -d "${temporary_dir}" \
    ...
    "${project_root}/thymeleaf-test/tests/java/org/thymeleaf/engine/EngineProcessableGolden.java"

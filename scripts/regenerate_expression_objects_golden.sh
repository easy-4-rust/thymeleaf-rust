...
output="${2:-${project_root}/tests/fixtures/expression_objects_golden.txt}"
...
javac -encoding UTF-8 -cp "${java_classpath}" -d "${temporary_dir}" \
    "${project_root}/tests/java/org/thymeleaf/standard/expression/ExpressionObjectsGolden.java"

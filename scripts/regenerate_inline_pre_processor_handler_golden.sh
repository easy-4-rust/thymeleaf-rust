...
output="${2:-${project_root}/thymeleaf/tests/fixtures/inline_pre_processor_handler_golden.txt}"
...
javac -encoding UTF-8 -d "${temporary_dir}" \
    ...
    "${project_root}/thymeleaf-test/tests/java/InlinePreProcessorHandlerGolden.java"

...
output="${2:-${project_root}/tests/fixtures/standard_conversion_service_golden.txt}"
...
javac -encoding UTF-8 -Xlint:unchecked -d "${temporary_dir}" \
    "${project_root}/tests/java/stubs/org/thymeleaf/context/IExpressionContext.java" \
    ...
    "${project_root}/tests/java/StandardConversionServiceGolden.java"

...
output="${2:-${project_root}/tests/fixtures/host_template_resource_golden.txt}"
...
javac -encoding UTF-8 -d "${temporary_dir}" \
    ...
    "${project_root}/tests/java/stubs/org/thymeleaf/templateresolver/WebApplicationTemplateResolver.java" \
    ...
    "${project_root}/tests/java/HostTemplateResourceGolden.java"

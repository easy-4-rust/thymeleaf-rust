...
output="${2:-${project_root}/thymeleaf/tests/fixtures/element_tag_structure_handler_golden.txt}"
...
javac -encoding UTF-8 -cp "${java_classpath}" -d "${temporary_dir}" \
  ...
  "${project_root}/thymeleaf-test/tests/java/org/thymeleaf/engine/ElementTagStructureHandlerGolden.java"

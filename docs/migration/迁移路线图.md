...
以及 Processor 方言的 `IProcessorDialect`/`AbstractProcessorDialect` 已完成迁移。
下一步优先完成 `AbstractTextTemplateParser`、`TextTemplateParser`、JavaScript/CSS 入口和
...
**创建日期**：2026-07-28
**最后更新**：2026-07-29
**文档状态**：迁移实施中；89 / 491 个主对象已验证，2 个主对象已实现待完整验证

...
> **Rust 状态**：Cargo workspace 已建立；Foundation、方言基础配置、缓存对象族、文件/字符串模板资源、聚合与 List/Set/Map/Object 表达式垂直切片实施完成
...
| 508 个 Java 类型尚未迁移 | 主体功能仍不可用 | S1–S9 |

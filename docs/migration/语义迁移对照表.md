...
> **当前状态**：迁移实施中；Foundation、方言基础配置、缓存对象族与字符串模板资源垂直切片已完成 Java/Rust Golden 差分
...
| TemplateResource 对象语义 | 2 | 7 | 28.57% |
| Java 类型 | 25 | 560 | 4.46% |
| Java 主对象 | 25 | 491 | 5.09% |
...
**创建日期**：2026-07-28
**最后更新**：2026-07-29
**文档状态**：迁移实施中；Foundation、方言基础配置、缓存对象族与字符串模板资源切片语义已验证，其余语义保持 `NOT_STARTED`

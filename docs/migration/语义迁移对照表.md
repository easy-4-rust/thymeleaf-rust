...
> **当前状态**：迁移实施中；Foundation、方言基础配置、缓存合同、缓存有效性与缓存键垂直切片已完成 Java/Rust Golden 差分
...
**创建日期**：2026-07-28
**最后更新**：2026-07-29
**文档状态**：迁移实施中；Foundation、方言基础配置、缓存合同、缓存有效性与缓存键切片语义已验证，其余语义保持 `NOT_STARTED`

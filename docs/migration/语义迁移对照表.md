...
| 已实现 Java 类型 | 100 | 560 | 17.86% |
| 已实现 Java 主对象 | 91 | 491 | 18.53% |
...
**创建日期**：2026-07-28
**最后更新**：2026-07-29
**文档状态**：迁移实施中；Foundation、方言基础配置与 Processor 方言基础对象、缓存对象族、文件/字符串模板资源与参数、求值、标准表达式字面量/执行上下文/转换服务/NO-OP 值、聚合、Array/List/Set、`#bools`/`#aggregates`/`#arrays`/`#lists`/`#sets`/`#maps`/`#objects` 表达式 facade、对象、日志、模式、版本及完整 `TextUtils` 工具切片语义已验证，其余语义保持 `NOT_STARTED`

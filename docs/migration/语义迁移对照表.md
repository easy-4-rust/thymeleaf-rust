...
两个上游测试文件的 `test01` 生成规则和 `test02` 手写回归集合均已登记为
`SOURCE_PARITY`。全工作区覆盖率为 20,835 行、1,925 函数、28,544 区域，三项
100%。Markup 两个 Reader 仍为 `NOT_STARTED`。
...
| Text comment Reader 对象语义 | 3 | 5 | 60.00% |
| 通用工具对象语义 | 16 | 37 | 43.24% |
| 已实现 Java 类型 | 92 | 560 | 16.43% |
| 已实现 Java 主对象 | 83 | 491 | 16.90% |

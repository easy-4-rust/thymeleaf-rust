...
> **当前状态**：迁移实施中；Foundation 与 `TemplateSpec` 垂直切片已完成 Java/Rust Golden 差分
...
| 维度 | 已迁移 | 规划总数 | 完成率 |
|:---|---:|---:|---:|
| Engine/配置语义 | 1 | 7 | 14.29% |
| TemplateMode 对象语义 | 5 | 5 | 100% |
| Java 类型 | 11 | 560 | 1.96% |
| Java 主对象 | 11 | 491 | 2.24% |
...
**创建日期**：2026-07-28
**最后更新**：2026-07-28
**文档状态**：迁移实施中；Foundation 与 `TemplateSpec` 语义已验证，其余语义保持 `NOT_STARTED`

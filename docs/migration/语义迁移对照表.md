...
| 通用工具对象语义 | 14 | 37 | 37.84% |
| 已实现 Java 类型 | 57 | 560 | 10.18% |
| 已实现 Java 主对象 | 52 | 491 | 10.59% |
...
**创建日期**：2026-07-28
**最后更新**：2026-07-29
**文档状态**：迁移实施中；Foundation、方言基础配置、缓存对象族、文件/字符串模板资源与参数、求值、聚合、Array/List/Set、`#bools`/`#aggregates`/`#arrays`/`#lists`/`#sets`/`#maps`/`#objects` 表达式 facade、对象、日志、模式及版本工具切片语义已验证，其余语义保持 `NOT_STARTED`

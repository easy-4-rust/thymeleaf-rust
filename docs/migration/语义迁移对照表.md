...
| 通用工具对象语义 | 10 | 37 | 27.03% |
| 已实现 Java 类型 | 49 | 560 | 8.75% |
| 已实现 Java 主对象 | 45 | 491 | 9.16% |
...
**创建日期**：2026-07-28
**最后更新**：2026-07-29
**文档状态**：迁移实施中；Foundation、方言基础配置、缓存对象族、文件/字符串模板资源与参数、List/Set、`#lists`/`#sets`/`#maps`/`#objects` 表达式 facade、对象、模式及版本工具切片语义已验证，其余语义保持 `NOT_STARTED`

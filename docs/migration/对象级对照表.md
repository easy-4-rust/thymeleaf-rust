...
| 164 | `Objects` | class | `lib/thymeleaf/src/main/java/org/thymeleaf/expression/Objects.java` |`thymeleaf/src/expression/objects.rs`| `Objects` | `JavaObjectArray`、`ObjectsError`（Rust 运行时数组适配） | 1:1 | BEHAVIOR_VERIFIED |
...
| 441 | `AggregateUtils` | class | `lib/thymeleaf/src/main/java/org/thymeleaf/util/AggregateUtils.java` |`thymeleaf/src/util/aggregate_utils.rs`| `AggregateUtils` | `JavaBigDecimal`、`JavaNumber`、`JavaAggregateObject`、`JavaNumberIterable`、`JavaNumberList`、`AggregateError`（Rust 数值/动态对象适配） | 1:1 | BEHAVIOR_VERIFIED |
| 442 | `ArrayUtils` | class | `lib/thymeleaf/src/main/java/org/thymeleaf/util/ArrayUtils.java` |`thymeleaf/src/util/array_utils.rs`| `ArrayUtils` | `ArrayTarget`、`JavaArray`、`JavaArrayElement`、`JavaArrayType`、`ArrayUtilsError`（Rust JVM 数组适配） | 1:1 | BEHAVIOR_VERIFIED |
...
| 448 | `EvaluationUtils` | class | `lib/thymeleaf/src/main/java/org/thymeleaf/util/EvaluationUtils.java` |`thymeleaf/src/util/evaluation_utils.rs`| `EvaluationUtils` | `JavaMapEntry`（对应 `MapEntry`）；`JavaEvaluationValue`、`JavaBigDecimalResult`、`JavaEvaluationElement`、`JavaEvaluationTarget`、`JavaEvaluationList`、`JavaEvaluationArray`、`EvaluationError` 等 Rust JVM 适配 | 1:1 | BEHAVIOR_VERIFIED |
...
| 456 | `LoggingUtils` | class | `lib/thymeleaf/src/main/java/org/thymeleaf/util/LoggingUtils.java` |`thymeleaf/src/util/logging_utils.rs`| `LoggingUtils` | `JavaString`、`JavaStringResult`（Rust UTF-16/身份适配） | 1:1 | BEHAVIOR_VERIFIED |
...
| 467 | `TextUtils` | class | `lib/thymeleaf/src/main/java/org/thymeleaf/util/TextUtils.java` |`thymeleaf/src/util/text_utils.rs`| `TextUtils` | `JavaCharSequence`、`TextUtilsError`（Rust 动态 CharSequence/Java 异常适配） | 1:1 | BEHAVIOR_VERIFIED |

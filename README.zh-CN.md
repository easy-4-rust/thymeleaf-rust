...
| Rust 公共 API | 已验证切片 | Foundation/配置 API、缓存对象族，以及模板资源 SPI/字符串资源/文件资源；URL 资源的 file/HTTP/HTTPS 已实现待完整协议验证 |
...
| 测试与 CI | 切片门禁通过 | 76 个单元测试、8 个共 653 条记录的 Java/Rust Golden 测试、行/函数/区域覆盖率均为 100% |

...
use support::thtest_harness::{
    build_context, directive_section_for_marker, named_input_sections, named_template_modes,
    CorpusStringTemplateResolver,
};
...
const FIXTURES: &[(&str, &str)] = &[
    ...
    ("block01", "e067e11199c27ebccb7aa64b2a25fb749e6c11be3cf0d6e645077f3269be7fcb"),
    ("block02", "f082f2a8f74f1367b281d6ceaca26e44fb513bbce518c46f148fdd7f4d444cb0"),
    ("block03", "030e977d96f201589d5a2bdd262899074a845a2ae8d18d300599bf65150f3337"),
    ("block04", "b0a2ffa952f051eb1d4dd8444301872418e66a200828c13bba302a306dec7ecd"),
    ("block05", "ac74e85fbfcd379b093174d4a9513475fb77bd1ce45caf0e8bdf95e7672edeca"),
    ("block06", "c7298bf9499bfcd2738f2073630f1c69d8e30a348fef66af90b6a89655583f14"),
    ("block07", "8b773e98e9fc3d610a29703e54dfeedf28de0ed19991fba3f0c67945948dac6a"),
    ("block08", "3b89478d5c40fb3c47c87fbf920cfb6a7b0e639e9f794ad874489d9041cea4bf"),
    // conditionalcomments（StandardConditionalCommentProcessor/Utils/FixedValue）
    ("conditionalcomments01", "649a0b0c3b5c20127c2ec929f7a6d11f9dc7ece29783f15b1f29dac878859c83"),
    ("conditionalcomments02", "7c138601fb27f6cb1a2af58ce8482565e8aebd6d2327316e1bc2795a7cea08ff"),
    ("conditionalcomments03", "98655a679f2df67b3cd997e9eb89c49043a3e9127e4d8ffeac5073be106c809a"),
    ("conditionalcomments04", "cc78a2c44817b2eb935ca04aae590fd168e800d5f2038cc56995be85dc4780bf"),
    ("conditionalcomments05", "649152b26b5c45ee547a3f8d7b693a3065a70aa57c138441061e60e5fcaf85bd"),
    ("conditionalcomments06", "e8ec53adc28d371f28574ec9dbc0a56aacd13c4466aa38c722611f3d29050337"),
    ("conditionalcomments07", "d5dc400215c240f719899572a2009a13e76cacc2bef67623d59baec908a073a1"),
    ("conditionalcomments08", "8772d2e0d7a82f384ba01b8b6c51bd219fd9999184acbea5848953c177fa2a57"),
    // attrprocessors/domevent（StandardDOMEventAttributeTagProcessor）
    ("onclick01", "952d3e53c68a8476c279cafb756fad880e6a3dcdff6acf2bcf6d6350734fd5a4"),
    ("onclick02", "ae6bfb9cfc5145ea8e8634ee6374371b4440bb70fb320136ac3d2f31c7eb2da5"),
    ("onchange01", "e7f734155a91363a9494969cc8f197fcebc38198f28333e77c84a081eb130bfb"),
    ("onchange02", "2cdf3d66b0390f18bd5111042dfe2ac0edabc36f2ee7d870f58781d44240bd78"),
    // attrprocessors/insert（StandardUtextTagProcessor）
    ("insert090", "19dacdaf06688399bc30304bf2f5fd71a766c2357c5b4f7cfde3ea1362f7930c"),
    ("insert100", "fc60e14e55f5568514922172d72b7f32635910cdc7090cc36c7dce58370d8adc"),
    // attrprocessors/insert|replace（StandardRefAttributeTagProcessor）
    ("insert058", "e757ad78c5553714c77bfd77c7835ab371cc1fb73c276c8271e0e644bfb8f007"),
    ("insert059", "cf8d422b8a2a5dd90e6ac65dd71d8a670a9f6d2f265fe364640acb3f0a556ef5"),
    ("insert060", "eaadfde5b39e66d0b49f1191310b88607e24636c6a377e2927f62447f4c17cf1"),
    ("replace058", "facc9577e65e22ab6bf013028e1b912761397ea9c505e9b661f7d88cb5215ad0"),
    ("replace059", "73cbb75084b7f20708b7285f8f85be6b598774fa670fdb951a620bb6a86d4822"),
    ("replace060", "e058b4eefa7f8594ec33498002f795ac8992625d1a2eef961cd5aa5a340484dd"),
    // xmlns（StandardXmlNsTagProcessor + StandardTranslationDocTypeProcessor）
    ("xmlns01", "7a81940c898e36c4dd541317982ccafff2f268b63e776f165cfacd9af38789ac"),
    ("xmlns02", "28a741bd4a01941f7bcd4b3c1cfb2c394b8942cdfa6ec2b23bfb68d92cb46a07"),
    ("xmlns03", "bc92fd0b54fd8f55b44d3a08f558e8d6427db23c762c2d15bde21a498dc90cd4"),
    ("xmlns04", "b29dd50430694a3d9d40452dc6f4b58ef4313c4910577caa5c6c95f9df096efe"),
    ("xmlns05", "91450dffd66e13fffd16a1293faa64fd4c553a8b5f90c306e3f021997e8004e0"),
    ("xmlns06", "3940d4252fc58ecfe8473f7b8330a3e49230003b6ae7b2b350fa6ffb79d748e2"),
    ("xmlns07", "e996b8b0b02b7cb7be38b539194c5109a8f6608f66628582141596c19c25ff2c"),
    ("xmlns08", "959259de46e29c87f42df760d24d1ed6fd1abe73f0b104f69ecdcb92288aee09"),
    ("xmlns09", "f6b17e178b79433dd7aeb5996c65362423358b5f73cbbd88eae448ca81550888"),
    // attrprocessors/inline（StandardInlineTextualTagProcessor/InliningText/XMLInliner）
    ("inline08", "bd113ad961730e3acb8a667f57efeb1460d54538232a8d89453151e4044f811e"),
    ("inline09", "03149fe9d57fa22eb3c4ad4a76174543a86901ede0119c94e17413d078195395"),
    ("inline29", "3fcbba09494439785fe51ec998b12eccf01214c439a6356736766492b581a704"),
    ("inline33", "061789b7359cef7ab314bb7f10cbae2978c1bfd82a56daf7d5e92aa1a075c361"),
    // dataprefix（StandardStyleappendTagProcessor）
    ("styleappend01", "a57cef5a29f431c4df52f1ef8b6b1eae045c0b0d57d76f437575fb7b3f347fb1"),
];

fn fixture_bytes(name: &str) -> Vec<u8> {
    std::fs::read(format!("tests/fixtures/processorfamily/{name}.thtest"))
...
fn load_case(name: &str) -> ProcessorCase {
    ...
    let input = directive_section_for_marker(&content, "%INPUT")
        .expect("INPUT section exists");
